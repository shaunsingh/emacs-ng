...
use crate::{
    ...
    remacs_sys::{
        block_input, fontset_from_font, gui_default_parameter, gui_display_get_arg, hashtest_eql,
        image, make_hash_table, register_font_driver, unblock_input, Display, Emacs_Pixmap,
        Fcopy_alist, Fprovide, Pixmap, Qfont, Qfont_backend, Qminibuffer, Qname, Qnil, Qparent_id,
        Qterminal, Qunbound, Qwr, Qx, WRImage, Window, XrmDatabase, DEFAULT_REHASH_SIZE,
