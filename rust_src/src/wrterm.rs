...
use crate::{
    ...
    remacs_sys::{
        block_input, fontset_from_font, gui_display_get_arg, hashtest_eql, image, init_frame_faces,
        make_hash_table, register_font_driver, unblock_input, Display, Emacs_Pixmap, Fcopy_alist,
        Fprovide, Pixmap, Qbackground_color, Qfont, Qfont_backend, Qforeground_color, Qminibuffer,
        Qname, Qnil, Qparent_id, Qterminal, Qunbound, Qwr, Qx, WRImage, Window, XrmDatabase,
