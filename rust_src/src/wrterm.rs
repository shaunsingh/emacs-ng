...
use crate::{
    ...
    remacs_sys::{
        block_input, font, gui_display_get_arg, hashtest_eql, make_frame,
        make_frame_without_minibuffer, make_hash_table, make_minibuffer_frame, output_method,
        unblock_input, wr_output, Display, Emacs_Pixmap, Fcopy_alist, Fprovide, Pixmap,
        Qminibuffer, Qname, Qnil, Qnone, Qonly, Qparent_id, Qterminal, Qunbound, Qwr, Qx, WRImage,
